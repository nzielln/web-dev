    ...
    return(
        <div className="d-flex flex-column align-content-between wd-bio mt-3">
            <div className="d-flex justify-content-end " style={{"width": "100%"}}>
                <button className="p-1" style={{"width": "120px", "backgroundColor": "transparent", "color": "white", "border": "1px" +
                    " solid grey", "borderRadius": "15px", "fontWeight": "bold"}}>Edit Profile </button>
            </div>
            <div className="d-flex flex-column align-items-start">
                ...
                <div className="d-flex justify-content-between mb-2" style={{"width": "40%"}}>
                    <p className="mb-0 wd-profile-stats"><span className="pe-1">{user.stats.following}</span> Following</p>
                    <p className="mb-0 wd-profile-stats"><span className="pe-1">{user.stats.followers}</span> Followers</p>
                </div>
            </div>
        </div>
    );
